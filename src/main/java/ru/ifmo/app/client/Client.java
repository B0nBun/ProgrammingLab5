...
/**
 * Commands TODO: add; add if max; clear; count greater than fuel type; execute script; filetr
 * greater than fuel type; group counting by id; head; info; remove; lower; save; show; update
 */
