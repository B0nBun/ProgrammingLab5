...
public enum FuelType {
     ...
     * <p>
     * Given string can be either the enumeration value,
     * regardless of the characters' registery (e.g. "GaSolIne"),
     * or it can be enumeration's value's index, starting with 1
     * (e.g. "1" will be interpreted as {@link FuelType#GASOLINE})
     * </p>
     * 
