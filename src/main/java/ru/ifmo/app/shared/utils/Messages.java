package ru.ifmo.app.shared.utils;
...
public class Messages {
  ...
  /**
   * Get a message string from the "ApplicationMessages" resource bundle and format it with the
   * given arguments. Gets the string using the {@link ResourceBundle#getString} to get the message
   * and formats it with the {@link MessageFormat#format} method. If any of the methods throw
   * {@link MissingResourceException} or {@link IllegalArgumentException} then returns a string
   ...
   * @return Formatted string. If the given key is missing or formatting fails then string contains
   *         the key and arguments themselves (e.g. "NonExistantKey[123, "Other arg"]")
   */
