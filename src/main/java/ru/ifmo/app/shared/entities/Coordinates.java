...
public record Coordinates(Long x, Integer y) implements Serializable {
    ...
    public Element toXmlElement() {
        Element coordinatesElement = new Element(VehiclesXmlTag.COORDINATES.toString())
            .setAttribute(
                VehiclesXmlTag.COORDINATES_X_ATTR.toString(),
                this.x().toString()
            )
            .setAttribute(
                VehiclesXmlTag.COORDINATES_Y_ATTR.toString(),
                this.y().toString()
            );
     ...
     */
    public static Coordinates fromXmlElement(Element coordinatesElement)
        ...
        Long x = null;
        try {
            String xString = coordinatesElement.getAttributeValue(
                VehiclesXmlTag.COORDINATES_X_ATTR.toString()
            );
        ...
        Integer y = null;
        try {
            String yString = coordinatesElement.getAttributeValue(
                VehiclesXmlTag.COORDINATES_Y_ATTR.toString()
            );
    ...
    public static final class fields {
        ...
        public static final FieldSchemaNum<Integer> y = FieldSchema
            .integer()
            .nonnull()
            .max(-738);
    }
