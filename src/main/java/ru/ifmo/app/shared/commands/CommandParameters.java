...
public abstract class CommandParameters implements Serializable {
  public final static CommandParameters dummy = new CommandParameters() {};

  public final static String description(Class<? extends CommandParameters> clazz) {
